...
type User struct {
	...
	Avatar      string     `xorm:"'avatar' varchar(50)" json:"avatar"`               // 用户头像
	...
	ExpireTime  int64      `xorm:"varchar(255)" json:"expireTime"`                   // 导出时间
	CreateTime  int64      `xorm:"varchar(255)" json:"createTime"`                   // 创建时间
	UpdateTime  int64      `xorm:"varchar(255)" json:"updateTime"`                   // 更新时间
}
